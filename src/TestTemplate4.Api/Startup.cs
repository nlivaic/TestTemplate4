...
using TestTemplate4.Api.Helpers;
using TestTemplate4.Api.Middlewares;
using TestTemplate4.Application;
...
namespace TestTemplate4.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var connString = new SqlConnectionStringBuilder(_configuration.GetConnectionString("TestTemplate4DbConnection") ?? string.Empty)
                {
            ...
            services.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc(
                    "TestTemplate4OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate4 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate4.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate4.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate4Client", builder =>
            {
            ...
            services.AddTestTemplate4ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate4DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate4Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate4OpenAPISpecification/swagger.json", "TestTemplate4 API");
